...
class ChatRequest(BaseModel):
    ...
    conversation_id: Optional[UUID] = Field(None, description="UUID существующего диалога (опционально)")
    top_k: int = Field(3, ge=1, le=10, description="Количество релевантных документов")
    max_tokens: int = Field(512, ge=1, le=2048, description="Максимальное количество токенов для ответа")
